...
3. ОБОВ'ЯЗКОВО виклич get_file_content ОДИН раз для головного файлу
   застосунку (зазвичай main.py, app.py або bot.py - подивись на список
   файлів і визнач сам, який із них є точкою входу) - саме там зазвичай
   міститься обробка помилок, яку важливо оцінити. Більше НЕ викликай
   get_file_content для інших файлів.
